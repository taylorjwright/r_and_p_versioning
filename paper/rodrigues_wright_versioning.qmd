...
Instead of using the Posit Package Manager with a fixed date, we could have used
the `{groundhog}` package by @simonsohn2023. This package makes it possible to
...
As an illustration of this, we rewrote parts of the original study as a `{targets}`
pipeline.
