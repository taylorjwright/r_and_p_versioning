...
guide to using Docker and {renv} to ensure the reproducibility of 
research.
...
and by writing a pipeline using a tool like {targets} instead of using scripts, 
researchers improve readability. But this is not only useful for making projects
