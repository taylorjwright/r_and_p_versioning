...
While the exact scope and definition is subject to ongoing debate, replication is, broadly speaking, in some sense re-testing a hypothesis while changing an element of previous research (e.g. the sample, or the estimating equation) whereas reproducibility (sometimes referred to as verification or computational reproducibility) is following a study's protocol exactly and obtaining the results presented in the study (see @clemens2017meaning, @nosek2020replication for further discussion). 
