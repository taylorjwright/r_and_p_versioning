...
![We can now see that one of the outputs is out of date. \label{fig_dag_ood}](./figures/figure3_dag_ood.png)
...
![The graph opens in your web browser, and it is possible to zoom in. \label{fig_dag_zoom}](./figures/figure5_dag_zoom.png)
