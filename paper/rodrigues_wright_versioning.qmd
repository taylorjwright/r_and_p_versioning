...
However, one must be aware that while Docker offers many benefits, it is not a 
...
This means that an image built on (and thus for) the 64-bit CPU architecture 
...
running containers from this image. However, more and more base images that can
