...
![Every output has now been computed. \label{fig_dag_after}](./figures/figure3_dag_after.png)
...
![The graph opens in your web browser, and it is possible to zoom in. \label{fig_dag_zoom}](./figures/figure3_dag_zoom.png)
