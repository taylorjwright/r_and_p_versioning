...
published results hold up to replication in other settings has lead to large
...
While the *replicability* of studies has recieved much attention, there has been
...
condition of publication. Some journals, such as the American Econonmic Review
(AER) or American Journal of Political Science (AJPS), even have verification
policies that require authors upload their replication materials and have their
results verified by another team (either the journal's replication team (AER) or
a third party, (AJPS)) prior to publication. However, even if these materials
...
Preferences'', @davenport2022multiracial, that details that replication
...
First, we add to the discussion of importance of availablility of replication materials. 
Existing research documents that the availability of replication materials is associated with a higher citation count (@stockemer2018data, is this reference true?) and with a higher likelihood of replication (@philip2010report). 
Much of this research focuses on the provision of data and code as a necessary condition for facilitating replication and rebuilding trust in science (), while  .
