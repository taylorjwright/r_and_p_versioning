...
be used to start off a researchers own analysis both ship an amd64 and arm64
version, which means that at the very least, reproducers will be able to rebuild 
