...
knitr::include_graphics("./figures/figure3_dag_before", error = FALSE)
```
...
knitr::include_graphics("./figures/figure4_dag_after", error = FALSE)
```
...
knitr::include_graphics("./figures/figure5_dag_ood", error = FALSE)
```
...
knitr::include_graphics("./figures/figure6_dag_zoom", error = FALSE)
```
