...
# this is the many seeds script
# get a vector of seed

x <- withr::with_seed(123,
                      sample(1:10000000, 100))
...
saveRDS(m2m, paste0("outputs/m2m_", r_version, "_seed_", x, ".rds"))
...
saveRDS(m2w, paste0("outputs/m2w_", r_version, "_seed_", x, ".rds"))
